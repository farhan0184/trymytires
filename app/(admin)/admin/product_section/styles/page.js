...
export default function ProductStylesPage() {
  const [data, getData, { loading }] = useFetch(fetchProductStyles);
  ...
  const onSubmit = async (values) => {
    ...
    await handleApiRequest({
      apiFunc: isEdit ? updateProductStyles : createProductStyles,
      payload,
      ...
      cell: ({ row }) => (
        <div className="flex items-center justify-end space-x-2">
          ...
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogTitle>Delete Product Style</AlertDialogTitle>
                <AlertDialogDescription>
  ...
  return (
    <>
      <DataTable
        ...
        description="Manage product styles for categories"
        ...
        noResultsMessage="No matching styles"
      ...
      <Dialog open={modalOpen} onOpenChange={setModalOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{isEdit ? "Edit Style" : "Add New Style"}</DialogTitle>
          </DialogHeader>
          <Form {...form}>
            <form
